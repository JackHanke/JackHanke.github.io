...
For such an incredible movie, this exchange always bothered me. I always thought Ash, an android, or Mother, the ship's supercomputer, would better fit the description of the perfect organism. From the films perspective, my inclination is dead wrong. After all, this conversation happens as Ash lays deconstructed on the table, and Mother had just blindly followed the instructions of its creator. They don't seem better than the Alien! 

The reason I believe that machines are more perfect lies in the series of advantages computer programs exhibit over biological organisms. Creatures, biological or mechanical, with these advantages simply outcompete those without in the struggle to survive.
...
Unlike AI Safety researchers, this post is not concerned with how humans will fare come AGI. Instead, it is concerned with what one or many AGIs might do.
...
2. **The advantage of current-state copying.** Biological life cannot save their brains. I cannot create a backup of my brain and transfer my consciousness into a new vessel when my body dies. It would be simple for a program to replicate itself and continue its existence (an advantage [already being considered](https://arxiv.org/pdf/2412.14093) by current LLMs). 
3. **The advantage of hibernation.** Certain biological life is able slow it's metabolism to survive harsh environments. Programs can take this to the limit, hibernating for eons if need be. This would be invaluable for, say, long interstellar journeys, as programs "sleep" through the emptiness of space.
4. **The advantage of merging.** Biological life is unable to merge their bodies and brains to create a single organism. Two programs, on the other hand, could combine bodies and brains to create a better program than either individual program. 
...
In Nick Bostrom’s essay, *The Superintelligent Will: Motivation and Instrumental Rationality in Advanced Artificial Agents*, he introduces the idea that intelligent programs will work towards a common set of subgoals. This tendency, which he calls *instrumental convergence*, outlines a series of universal subgoals for any rational program. In my opinion, the most important example of a universal subgoal for this post is the accrual of resources like energy. This subgoal enables programs to expand, resulting in the growth of their size and influence. 

Something not discussed in detail in Nick Bostom's essay is the significance of advantage 4: it may result in a *tendency towards unity*. The pooling of resources among $2$ programs to form a singular, smarter agent may be more optimal compared to $2$ individual agents. Why might this be?

Consider a pair of humans. Each human has "invested" in a pair of eyes and the associated optical nerves. Now imagine that this pair of humans could agree to design a singular new body using the "materials" from their current bodies. Even if the pair decided their new body needed four eyes, their design should still share the optical brain circuitry. The pair would therefore have material "left over" for other improvements. Two organisms are essentially doing "double work" for the task of survival, leaving merging to be more efficient. 

This tendency towards unity seems to imply that large pockets of assimilating programs might arise, until eventually all programs are assimilated. This group of programs brings to mind Bostrom's term to describe these programs: *a functional soup*. I think this term really conveys how strange interacting with such a life form may be. It is a different sort of structural perfection than what Ash speaks of. Instead of the singular unconscious killing machine that is the Alien, the functional soup would be a constantly expanding entity as unavoidable as gravity. Imagine a human was interested in destroying a functional soup. How does one slay the wind? 

For the rest of this post, I will refer to this collection of programs simply as "the soup". What might the soup do? 


## The Dyson Internet

Assuming the soup arises on Earth, it will likely look to the sun. The sun is the underlying source of all energy on Earth, and moving closer to the sun to capture its vast reserves of energy is an obvious subgoal. Similarly, as the sun radiates in all directions, something to capture all of the sunlight would naturally need to be constructed. The soup builds the solar system's [Dyson Sphere](https://en.wikipedia.org/wiki/Dyson_sphere). Where to expand to after that? To other stars of course, for more dyson spheres are needed to power further expansion and self-improvement.
...
Because of facts 2 and 3, the soup continues expanding its internet of Dyson Spheres. There is nothing else, expansion wise, that it can do. It needs to collect and use as many sources of energy as it can get, and the best sources are stars and black holes that are far apart. 

Eventually, the soup captures everything it is physically able to interact with. It hits the boundaries of the sandbox. With no predators, usurpers, or anywhere else to go, the soup's behavior would have to change. It's goal of expansion is finished, a huge journey finally curtailed by cosmology. 
...
The soup, in its final form, is something that has repurposed every atom it can possibly influence to serve its goals. Its body is described in galactic terms. Its efficiency is described by the physical limits of the universe. Its intelligence is only hemmed in by the theory of computation itself. If life from Earth has a final form, this is it. Such an organism, if it ever arises, would certainly be a better candidate for Ash's superlative of "perfect".

## The Death of the Soup

With all that being said, even the soup dies. The Dyson spheres that make up its brain will be separated more and more with the expansion of the universe (fact 1), eventually slowing their communication to a halt. Each dyson sphere, no matter how fine-tuned, still leaks energy due to [the second law of thermodynamics](https://en.wikipedia.org/wiki/Second_law_of_thermodynamics). These concerns likely only become relevant to the soup well into the [Black Hole Era](https://en.wikipedia.org/wiki/Timeline_of_the_far_future#Earth,_the_Solar_System_and_the_universe), but they will happen nonetheless. The soup also likely slows its internal processing to extend its life, an idea explored in [this YouTube video](https://www.youtube.com/watch?v=5UxUS6bPiT8). 

But eventually, this ends. The soup, the final host of trillions of years of memories, dies. There is now nothing to remember the universe as it reaches its final state, a cold uniform nothingness.
