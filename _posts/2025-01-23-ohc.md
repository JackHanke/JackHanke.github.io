...
2. The process for oxidation in [copper blocks](https://minecraft.fandom.com/wiki/Block_of_Copper) is different than other random tick events. What are the optimal times for harbesting a specific oxidation stage for copper?
